...
projectsBtn.addEventListener('click', function() {
    if (projectCards.style.display !== 'flex') {
        ...
        contactsCards.animate(dissapear, { duration: 500, fill: 'forwards', easing: "ease-out" })
        meCards.animate(dissapear, { duration: 500, fill: 'forwards', easing: "ease-out" })
        projectCards.animate(appear, { duration: 500, fill: 'forwards', easing: "ease-in" })
        setTimeout(function() {
...
meBtn.addEventListener('click', function() {
    if (meCards.style.display !== 'flex') {
        ...
        contactsCards.animate(dissapear, { duration: 500, fill: 'forwards', easing: "ease-out" })
        projectCards.animate(dissapear, { duration: 500, fill: 'forwards', easing: "ease-in" })
        meCards.animate(appear, { duration: 500, fill: 'forwards', easing: "ease-out" })
        setTimeout(function() {
...
contactsBtn.addEventListener('click', function() {
    if (contactsCards.style.display !== 'flex') {
        ...
        projectCards.animate(dissapear, { duration: 500, fill: 'forwards', easing: "ease-in" })
        meCards.animate(dissapear, { duration: 500, fill: 'forwards', easing: "ease-out" })
        contactsCards.animate(appear, { duration: 500, fill: 'forwards', easing: "ease-out" })
        setTimeout(function() {
            meCards.style.display = 'none';
            projectCards.style.display = 'none';
